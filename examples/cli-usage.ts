...
async function cliExamples() {
  ...
  console.log('You can also use environment variables instead of CLI arguments:\\n');
  ...
  console.log('\\x1b[33mexport API_HEADERS="Authorization:Bearer token,X-API-Key:key"\\x1b[0m');
  ...
  console.log('\\x1b[33mdocker run -v /path/to/spec:/app/spec.json your-mcp-server \\\\\\x1b[0m');
  ...
  console.log('\\x1b[33mcat openapi.json | docker run -i your-mcp-server \\\\\\x1b[0m');
  console.log('\\x1b[33m  --api-base-url https://api.example.com \\\\\\x1b[0m');
        ...
        mcpServers: {
          "local-api": {
            ...
            args: [
              ...
              "--openapi-spec", "/path/to/local-spec.yaml",
              "--debug"
            ]
          }
        }
